...
const LastWord = (str) => {
    ...
    const words = str.slice(str.lastIndexOf(' ')+1);
...
const replaceWords = (str) => {
    ...
    words.splice(words.indexOf('I'),1,"We");
        
    }
    if (words.indexOf("am") != -1){
    words.splice(words.indexOf('am'),1,"are");
        
    }
    if (words.indexOf("was") != -1){
        words.splice(words.indexOf('was'),1,"were");
    }
